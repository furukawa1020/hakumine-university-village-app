        ...
        <div className="px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className={locationSharing ? 'bg-green-50 border-green-200' : ''}
            >
              {locationSharing ? <Eye className="h-4 w-4 mr-1" /> : <EyeOff className="h-4 w-4 mr-1" />}
              位置共有
            </Button>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">位置共有</span>
                    <Button
